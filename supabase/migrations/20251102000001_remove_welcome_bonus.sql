-- ============================================================================
-- REMOVE AUTOMATIC WELCOME BONUS FOR NEW ACCOUNTS
-- Aligns initial balances with zero-credit expectation
-- ============================================================================
...
COMMENT ON FUNCTION public.handle_new_user() IS
  'Bootstrap profiles for auth users without seeding non-zero credit balances.';
